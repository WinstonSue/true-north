...
If you are using a mismatched version of dayjs with @sue/design-web-vue dependent dayjs in your project. That would be a problem cause locale not working.
