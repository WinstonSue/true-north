...
| Custom semantic styles | demo/style-class.md |
...
> [App wrapper component](../app/docs.md) can be used to simplify the problem of `useNotification` and other methods that need to manually implant contextHolder.
