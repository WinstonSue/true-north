...
```tsx
import { ChevronLeft, ChevronRight, Download, Minus, Plus, Search as SearchIcon, Smile } from 'lucide-react'
import React, { useState } from 'react';
;
import type { ConfigProviderProps, RadioChangeEvent } from '@sue/design-web-react';
import Steps from '@/components/docs-steps';
import { Badge, Button, Cascader, Col, ConfigProvider, Divider, Flex, Input, InputNumber, Modal, Pagination, Radio, Rate, Row, Select, Space, Switch, Tree, TreeSelect } from '@sue/design-web-react';
      ...
      <Row>
        <Col span={12}>
          ...
          <Flex wrap gap="small">
            ...
            <Space.Compact>
              <Button type="primary" icon={<ChevronLeft  />}>
                Backward
              </Button>
              <Button type="primary" icon={<ChevronRight  />} iconPlacement="end">
                Forward
              </Button>
            </Space.Compact>
        ...
        <Col span={24}>
          ...
          <Flex vertical gap="large">
            <Flex vertical gap="middle">
              ...
              <SearchIcon placeholder="input search text" enterButton="Search" size="large" />
              <Space.Compact>
                {selectBefore}
            ...
            <Row>
              ...
              <Col span={12}>
                ...
                <Flex align="center" gap="middle">
                  ...
                  <Space.Compact>
                    <Button icon={<Minus  />} onClick={declineBadge} />
                    <Button icon={<Plus  />} onClick={increaseBadge} />
                  </Space.Compact>
                </Flex>
