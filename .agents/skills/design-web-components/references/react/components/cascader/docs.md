...
| --- | --- |
| Basic | demo/basic.md |
| Default value | demo/default-value.md |
| Custom trigger | demo/custom-trigger.md |
| Hover | demo/hover.md |
| Disabled option | demo/disabled-option.md |
| Change on select | demo/change-on-select.md |
...
| matchInputWidth | Whether the width of list matches input, ([how it looks](https://github.com/yuce-design/yuce-design/issues/25779)) | boolean | true |  |
