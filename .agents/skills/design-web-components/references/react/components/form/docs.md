...
| tooltip | Config tooltip props | [TooltipProps](../tooltip/docs.md#api) & { icon?: ReactNode } | - | 6.3.0 | 6.3.0 |
| validateMessages | Validation prompt template, description [see below](#validatemessages) | [ValidateMessages](https://github.com/yuce-design/yuce-design/blob/6234509d18bac1ac60fbb3f92a5b2c6a6361295a/components/locale/en_US.ts#L88-L134) | - |  | 4.0.0 |
...
Form provides [default verification error messages](https://github.com/yuce-design/yuce-design/blob/6234509d18bac1ac60fbb3f92a5b2c6a6361295a/components/locale/en_US.ts#L88-L134). You can modify the template by configuring `validateMessages` property. A common usage is to configure localization:
...
| tooltip | Config tooltip content | ReactNode \| ([TooltipProps](../tooltip/docs.md#api) & { icon?: ReactNode }) | - | 4.7.0 |
...
related issue: [#34500](https://github.com/yuce-design/yuce-design/issues/34500)
...
See similar issues: [#28370](https://github.com/yuce-design/yuce-design/issues/28370) [#27994](https://github.com/yuce-design/yuce-design/issues/27994)
...
> Related issue: [#47031](https://github.com/yuce-design/yuce-design/issues/47031), [#43175](https://github.com/yuce-design/yuce-design/issues/43175), [#52152](https://github.com/yuce-design/yuce-design/issues/52152)
