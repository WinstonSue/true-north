...
import { ColorPicker, Flex, Form, Input, InputNumber, Slider, Watermark } from '@sue/design-web-react';
import Typography from '@/components/docs-typography';
import type { ColorPickerProps, GetProp, WatermarkProps } from '@sue/design-web-react';
