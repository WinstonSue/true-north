...
本文档包含 Sue Design 组件的语义化 DOM 描述信息。
...
- `source`:
  - `section`: 源区域元素，仅作用于左侧穿梭框容器样式
  - `header`: 源头部元素，仅作用于左侧头部区域样式
  - `title`: 源标题元素，仅作用于左侧标题文本样式
  - `body`: 源内容元素，仅作用于左侧列表主体区域样式
  - `list`: 源列表元素，仅作用于左侧列表内容区域样式
  - `item`: 源列表项元素，仅作用于左侧列表项样式
  - `itemIcon`: 源列表项图标元素，仅作用于左侧图标样式
  - `itemContent`: 源列表项内容元素，仅作用于左侧文本内容样式
  - `footer`: 源页脚元素，仅作用于左侧页脚区域样式
- `target`:
  - `section`: 目标区域元素，仅作用于右侧穿梭框容器样式
  - `header`: 目标头部元素，仅作用于右侧头部区域样式
  - `title`: 目标标题元素，仅作用于右侧标题文本样式
  - `body`: 目标内容元素，仅作用于右侧列表主体区域样式
  - `list`: 目标列表元素，仅作用于右侧列表内容区域样式
  - `item`: 目标列表项元素，仅作用于右侧列表项样式
  - `itemIcon`: 目标列表项图标元素，仅作用于右侧图标样式
  - `itemContent`: 目标列表项内容元素，仅作用于右侧文本内容样式
  - `footer`: 目标页脚元素，仅作用于右侧页脚区域样式
