...
Yuce Design React is dedicated to providing a **good development experience** for programmers. Before starting, it is recommended to learn [React](https://react.dev) first, and correctly install and configure [Node.js](https://nodejs.org/) v16 or above.
...
Here is a simple online codesandbox demo of an Yuce Design component to show the usage of Yuce Design React.




Follow the steps below to play around with Yuce Design yourself:
...
If you have already set things up by following the [Use with create-react-app](./use-with-create-react-app.md), replace the content of `/src/index.js` as follows:

```jsx
import React, { useState } from 'react';
import { DatePicker, message } from '@sue/design-web-react';
...
You can view the list of components in the side menu of the Components page, such as the [Alert](../../components/alert/docs.md) component. Plenty of examples are also provided in the component pages and API documentation as well.
...
```diff
- import { DatePicker, message } from '@sue/design-web-react';
+ import { DatePicker, message, Alert } from '@sue/design-web-react';
```
...
- [Yuce Design Pro](https://pro.ant.design/)
- [create-next-app](https://github.com/yuce-design/yuce-design-examples/tree/main/examples/with-nextjs-inline-style)
- More scaffolds at [Scaffold Market](https://scaffold.ant.design/)

## Test with Jest

If you use `create-react-app` follow the instructions [here](./use-with-create-react-app.md) instead.

Jest does not support `esm` modules, and Yuce Design uses them. In order to test your Yuce Design application with Jest you have to add the following to your Jest config :
...
`antd` supports tree shaking of ES modules, so using `import { Button } from '@sue/design-web-react';` would drop js code you didn't use.
