...
<template>
  <sue-form
    ...
    @finish="handleFinish"
  >
    <sue-form-item name="datePicker" label="DatePicker" :rules="itemRules">
      <sue-date-picker v-model:value="model.datePicker" style="width: 100%" />
    </sue-form-item>
    <sue-form-item name="dateTimePicker" label="DatePicker[showTime]" :rules="itemRules">
      <sue-date-picker v-model:value="model.dateTimePicker" show-time format="YYYY-MM-DD HH:mm:ss" style="width: 100%" />
    </sue-form-item>
    <sue-form-item name="monthPicker" label="MonthPicker" :rules="itemRules">
      <sue-date-picker v-model:value="model.monthPicker" picker="month" style="width: 100%" />
    </sue-form-item>
    <sue-form-item name="rangePicker" label="RangePicker" :rules="rangeRules">
      <sue-range-picker v-model:value="model.rangePicker" style="width: 100%" />
    </sue-form-item>
    <sue-form-item name="rangeTimePicker" label="RangePicker[showTime]" :rules="rangeRules">
      <sue-range-picker v-model:value="model.rangeTimePicker" show-time format="YYYY-MM-DD HH:mm:ss" style="width: 100%" />
    </sue-form-item>
    <sue-form-item name="timePicker" label="TimePicker" :rules="itemRules">
      <sue-time-picker v-model:value="model.timePicker" style="width: 100%" />
    </sue-form-item>
