...
import { InputNumber, Select } from '@sue/design-web-vue'
...
<template>
  <sue-form name="customized_form_controls" layout="inline" :model="model" @finish="handleFinish">
    <sue-form-item name="price" label="Price" :rules="[{ validator: checkPrice }]">
