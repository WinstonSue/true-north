...
- Use Form to collect, validate, submit, and manage structured user input. See `demo/basic.md`.
- Use layout, size, disabled, variant, and required mark demos to align form presentation. See `demo/layout.md`, `demo/size.md`, `demo/disabled.md`, `demo/variant.md`, and `demo/required-mark.md`.
- Use validation triggers, dynamic rules, dependencies, and scroll-to-field for robust validation flows. See `demo/validate-trigger.md`, `demo/dynamic-rule.md`, `demo/form-dependencies.md`, and `demo/validate-scroll-to-field.md`.
- Use dynamic item demos for repeatable or nested field sets. See `demo/dynamic-form-item.md`, `demo/dynamic-form-items.md`, and `demo/dynamic-form-items-complex.md`.
- Use modal, login, registration, or advanced search demos for common product flows. See `demo/form-in-modal.md`, `demo/login.md`, `demo/register.md`, and `demo/advanced-search.md`.
...
```ts
import { FormInstance } from '@sue/design-web-vue'
