...
- Use Tag for compact labels, categories, statuses, or selected values. See `demo/basic.md`.
- Use color, status, icon, closable/control, disabled, or checkable demos for label behavior. See `demo/colorful.md`, `demo/status.md`, `demo/icon.md`, `demo/control.md`, `demo/disabled.md`, and `demo/checkable.md`.
- Prefer Badge for counts or overlay status indicators.
