...
- Use Badge to show counts, status dots, or lightweight labels attached to another element. See `demo/basic.md` and `demo/dot.md`.
- Use standalone Badge when the count or status is itself the content. See `demo/no-wrapper.md`.
- Use `overflowCount`, offset, size, or color when the badge needs display tuning. See `demo/overflow.md`, `demo/offset.md`, `demo/size.md`, and `demo/colorful.md`.
- Use Ribbon for corner labels on cards or list items. See `demo/ribbon.md`.
