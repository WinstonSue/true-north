...
- Use FloatButton for floating page-level actions such as back-to-top, help, or quick commands. See `demo/basic.md`.
- Use FloatButton.Group for multiple related floating actions. See `demo/group.md`, `demo/group-menu.md`, and `demo/controlled.md`.
- Use badge, tooltip, shape, type, or placement variants for discoverability and positioning. See `demo/badge.md`, `demo/tooltip.md`, `demo/shape.md`, `demo/type.md`, and `demo/placement.md`.
- Prefer normal Button inside the content flow for local actions.
...
| closeIcon | Customize close button icon | VueNode | `<X />` | - |
