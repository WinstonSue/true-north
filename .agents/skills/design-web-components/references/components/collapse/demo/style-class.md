...
<template>
  <sue-flex vertical gap="middle">
    <sue-collapse :items="items" :classes="classes" :styles="stylesObject" :default-active-key="['1']" />
    <sue-collapse :items="items" :classes="classes" :styles="stylesFn" size="large" :default-active-key="['2']" />
  </sue-flex>
</template>
