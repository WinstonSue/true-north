...
- Use Collapse to reveal or hide secondary content while keeping page structure compact. See `demo/basic.md`.
- Use accordion mode when only one panel should be open at a time. See `demo/accordion.md`.
- Use custom headers, extra actions, or borderless/ghost styling to match dense settings or FAQ layouts. See `demo/custom.md`, `demo/extra.md`, `demo/borderless.md`, and `demo/ghost.md`.
- Prefer Tabs when content sections are peer views that should not stack vertically.
