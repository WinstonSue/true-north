...
<template>
  <sue-space wrap size="large">
    <sue-space direction="vertical" :size="8">
      <span>HEX String</span>
      <sue-color-picker v-model:value="hexValue" value-format="hex" />
      <span>value: {{ hexValue }}</span>
    </sue-space>

    <sue-space direction="vertical" :size="8">
      <span>RGB String</span>
      <sue-color-picker v-model:value="rgbValue" value-format="rgb" />
      <span>value: {{ rgbValue }}</span>
    </sue-space>

    <sue-space direction="vertical" :size="8">
      <span>HSB String</span>
      <sue-color-picker v-model:value="hsbValue" value-format="hsb" />
