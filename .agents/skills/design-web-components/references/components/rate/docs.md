...
- Use Rate for rating or scoring with a small ordinal scale. See `demo/basic.md`.
- Use half, text, clear, disabled, size, or custom character demos to tune rating behavior. See `demo/half.md`, `demo/text.md`, `demo/clear.md`, `demo/disabled.md`, `demo/size.md`, and `demo/character.md`.
- Prefer Slider for continuous numeric values and Radio for labeled discrete choices.
...
| character | The custom character of rate | VueNode \| (RateProps) => VueNode | &lt;Star /> | function(): 4.4.0 |
