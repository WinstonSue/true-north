...
- Use Statistic to display important numeric values with labels, prefixes, suffixes, or units. See `demo/basic.md` and `demo/unit.md`.
- Use card mode when statistics are shown as dashboard tiles. See `demo/card.md`.
- Use timer mode for countdown or time-based metrics. See `demo/timer.md`.
- Prefer Table or Descriptions for dense multi-field records.
