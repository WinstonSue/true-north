...
- Use Watermark to overlay ownership, security, or traceability marks on content. See `demo/basic.md`.
- Use image, multiline, custom, or portal demos for alternate watermark content and rendering targets. See `demo/image.md`, `demo/multi-line.md`, `demo/custom.md`, and `demo/portal.md`.
- Avoid Watermark for decorative backgrounds; it should communicate provenance or protection.
