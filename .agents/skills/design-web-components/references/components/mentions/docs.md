...
- Use Mentions when users type text with trigger-based suggestions such as `@user` or `#topic`. See `demo/basic.md`.
- Use async, prefix, placement, or auto-size demos for richer mention workflows. See `demo/async.md`, `demo/prefix.md`, `demo/placement.md`, and `demo/auto-size.md`.
- Use Form integration when mentions participate in validation or submission. See `demo/form.md`.
- Prefer AutoComplete for single-value suggestion input.
