...
- Use Progress to show task completion, upload state, or measurable status. See `demo/line.md` and `demo/circle.md`.
- Use dashboard, steps, segment, gradient, or dynamic demos for alternate visual forms. See `demo/dashboard.md`, `demo/steps.md`, `demo/segment.md`, `demo/gradient-line.md`, and `demo/dynamic.md`.
- Use format, size, linecap, or info-position demos to tune labels and dimensions. See `demo/format.md`, `demo/size.md`, `demo/linecap.md`, and `demo/info-position.md`.
- Prefer Spin for indeterminate loading.
