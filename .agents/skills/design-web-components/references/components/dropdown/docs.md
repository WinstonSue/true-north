...
- Use Dropdown for contextual actions, menus, or command groups attached to a trigger. See `demo/basic.md`.
- Use trigger, placement, arrow, or open control when interaction behavior needs tuning. See `demo/trigger.md`, `demo/placement.md`, `demo/arrow.md`, and `demo/overlay-open.md`.
- Use DropdownButton, selectable menus, submenus, or custom dropdown content for richer command menus. See `demo/dropdown-button.md`, `demo/selectable.md`, `demo/sub-menu.md`, and `demo/custom-dropdown.md`.
- Prefer Select for choosing form values and Popover for arbitrary informational content.
