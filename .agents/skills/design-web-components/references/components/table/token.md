...
| `cellPaddingBlockMD` | `number` | Vertical padding of table cell (medium size) |
| `cellPaddingInlineMD` | `number` | Horizontal padding of table cell (medium size) |
...
| `cellFontSizeMD` | `number` | Font size of table cell (medium size) |
