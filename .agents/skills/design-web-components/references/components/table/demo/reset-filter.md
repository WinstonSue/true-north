...
import type { TableEmits, TableProps } from '@sue/design-web-vue'
...
<template>
  <sue-space style="margin-bottom: 16px">
    <sue-button @click="setAgeSort">
      Sort age
    </sue-button>
    <sue-button @click="clearFilters">
      Clear filters
    </sue-button>
    <sue-button @click="clearAll">
      Clear filters and sorters
    </sue-button>
  </sue-space>
  <sue-table :columns="columns" :data-source="dataSource" @change="handleChange" />
</template>
```
