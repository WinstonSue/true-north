...
- Use InputNumber for numeric entry with parsing, formatting, min/max, or precision behavior. See `demo/basic.md`.
- Use formatter, digit, spinner, keyboard, wheel, and out-of-range demos for numeric interaction tuning. See `demo/formatter.md`, `demo/digit.md`, `demo/spinner.md`, `demo/keyboard.md`, `demo/change-on-wheel.md`, and `demo/out-of-range.md`.
- Use prefix/suffix, status, size, and variant demos for form integration. See `demo/presuffix.md`, `demo/status.md`, `demo/size.md`, and `demo/variant.md`.
- Prefer Slider when users adjust an approximate value visually.
