...
<template>
  <sue-flex vertical gap="16">
    <div>
      ...
      <sue-input v-model:value="value1" :count="{ show: true, max: 10 }" />
    </div>
    <div>
      <div>
        <sue-editable-text :level="5">
      ...
      <sue-input v-model:value="value2" :count="{ show: true, strategy: (txt) => runes(txt).length }" />
    </div>
    <div>
      <div>
        <sue-editable-text :level="5">
