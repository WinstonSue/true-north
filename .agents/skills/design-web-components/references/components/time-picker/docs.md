...
- Use TimePicker for selecting or typing a time or time range. See `demo/basic.md` and `demo/range-picker.md`.
- Use 12-hour, value format, need confirm, interval options, disabled, or hidden column demos for time rules. See `demo/12hours.md`, `demo/value-format.md`, `demo/need-confirm.md`, `demo/interval-options.md`, `demo/disabled.md`, and `demo/hide-column.md`.
- Use status, size, suffix, variant, or change-on-scroll demos for form integration. See `demo/status.md`, `demo/size.md`, `demo/suffix.md`, `demo/variant.md`, and `demo/change-on-scroll.md`.
- Prefer DatePicker with time when date and time are selected together.
