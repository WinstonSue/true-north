...
- Use Popover for contextual rich content attached to a trigger. See `demo/basic.md`.
- Use trigger, control, placement, arrow, or shift demos to tune interaction and positioning. See `demo/trigger-type.md`, `demo/control.md`, `demo/placement.md`, `demo/arrow.md`, and `demo/shift.md`.
- Prefer Tooltip for short text hints and Dropdown for action menus.
