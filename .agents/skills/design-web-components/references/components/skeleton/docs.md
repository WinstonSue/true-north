...
- Use Skeleton as a placeholder while content is loading and the final layout is known. See `demo/basic.md`.
- Use active, complex, element, or children demos for different loading surfaces. See `demo/active.md`, `demo/complex.md`, `demo/element.md`, and `demo/children.md`.
- Prefer Spin when the layout is unknown or the loading state is global and indeterminate.
