...
- Use Image for displaying images with optional preview behavior. See `demo/basic.md`.
- Use fallback or placeholder for unreliable or progressive image loading. See `demo/fallback.md` and `demo/placeholder.md`.
- Use preview group, controlled preview, custom preview source, toolbar, or render hooks for gallery workflows. See `demo/preview-group.md`, `demo/controlled-preview.md`, `demo/previewSrc.md`, `demo/toolbarRender.md`, and `demo/imageRender.md`.
- Prefer plain `img` when preview, fallback, or design-web styling is unnecessary.
