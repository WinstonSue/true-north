...
import type { DescriptionsProps } from '@sue/design-web-vue'
...
<template>
  <sue-flex vertical gap="middle">
    <sue-descriptions v-bind="descriptionsProps" :styles="styles" size="small" />
    <sue-descriptions v-bind="descriptionsProps" :styles="stylesFn" size="medium" />
  </sue-flex>
</template>
