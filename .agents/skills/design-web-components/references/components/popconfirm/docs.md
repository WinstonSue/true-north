...
- Use Popconfirm for lightweight confirmation attached to a specific action. See `demo/basic.md`.
- Use async or promise demos when confirmation performs async work. See `demo/async.md` and `demo/promise.md`.
- Use placement, icon, locale, or dynamic trigger demos for presentation and interaction tuning. See `demo/placement.md`, `demo/icon.md`, `demo/locale.md`, and `demo/dynamic-trigger.md`.
- Prefer Modal.confirm for heavier decisions or confirmations with more content.
...
| icon | Customize icon of confirmation | VueNode | &lt;CircleAlert /&gt; | - |
