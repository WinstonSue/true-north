...
<template>
  <sue-auto-complete
    ...
    :options="options"
  >
    <sue-input-search size="large" placeholder="input here" />
  </sue-auto-complete>
</template>

<style>
.certain-category-search-dropdown .sue-select-item-group {
  color: #666;
  font-weight: bold;
}

.certain-category-search-dropdown .sue-select-item-group:not(:last-child) {
  border-bottom: 1px solid #f6f6f6;
}

.certain-category-search-dropdown .sue-select-item-option-grouped {
  padding-inline-start: 16px;
}

.certain-category-search-dropdown .sue-select-item-option.show-all {
  text-align: center;
  cursor: default;
}
