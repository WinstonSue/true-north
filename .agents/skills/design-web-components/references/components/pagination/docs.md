...
- Use Pagination when a data set is split across pages. See `demo/basic.md`.
- Use controlled, changer, jump, simple, mini, total, or alignment demos for data-list workflows. See `demo/controlled.md`, `demo/changer.md`, `demo/jump.md`, `demo/simple.md`, `demo/mini.md`, `demo/total.md`, and `demo/align.md`.
- Prefer Table built-in pagination when pagination belongs directly to table data.
...
| size | Specify the size of `Pagination` | `small` \| `medium` \| `large` | `medium` | - |
