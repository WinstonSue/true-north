...
- Use Upload when users select, drag, paste, preview, transform, or submit files. See `demo/basic.md`, `demo/drag.md`, and `demo/paste.md`.
- Use fileList, defaultFileList, max count, manual upload, or custom action icon demos for controlled upload workflows. See `demo/fileList.md`, `demo/defaultFileList.md`, `demo/max-count.md`, `demo/upload-manually.md`, and `demo/upload-custom-action-icon.md`.
- Use picture-card, avatar, directory, crop image, preview file, transform file, or Aliyun OSS demos for media and storage flows. See `demo/picture-card.md`, `demo/avatar.md`, `demo/directory.md`, `demo/crop-image.md`, `demo/preview-file.md`, `demo/transform-file.md`, and `demo/upload-with-aliyun-oss.md`.
- Use file type, png-only, custom progress, or drag sorting demos when upload constraints or ordering matter. See `demo/file-type.md`, `demo/upload-png-only.md`, `demo/customize-progress-bar.md`, and `demo/drag-sorting.md`.
...
| fileList | List of files that have been uploaded (controlled). Here is a common issue [#2423] when using it, support `v-model:file-list` | [UploadFile](#uploadfile)\[] | - | - |
...
<img alt="click restart button on Chrome" src="" width="800" />
