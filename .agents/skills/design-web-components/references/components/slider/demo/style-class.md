...
<template>
  <sue-flex vertical gap="middle">
    <sue-slider v-model:value="value" class="custom-slider" :styles="stylesObject" />
    <sue-slider
...
.custom-slider-vertical:hover :deep(.sue-slider-handle):after {
  box-shadow: 0 0 0 2px #722ed1;
}

.custom-slider-vertical :deep(.sue-slider-handle):hover::after,
.custom-slider-vertical :deep(.sue-slider-handle):active::after,
.custom-slider-vertical :deep(.sue-slider-handle):focus::after,
.custom-slider-vertical :deep(.sue-slider-handle)::after {
  box-shadow: 0 0 0 2px #722ed1;
}
</style>
```
