...
- Use Slider for selecting a numeric value or range along a continuous track. See `demo/basic.md`.
- Use marks, tooltip formatting, input-number pairing, vertical, reverse, or event demos for numeric controls. See `demo/mark.md`, `demo/tip-formatter.md`, `demo/input-number.md`, `demo/vertical.md`, `demo/reverse.md`, and `demo/event.md`.
- Use range/multiple/editable/draggable track demos for multi-point selection. See `demo/multiple.md`, `demo/editable.md`, and `demo/draggableTrack.md`.
- Prefer InputNumber for exact numeric entry.
