...
- Use Anchor for in-page navigation across long documents, settings pages, or detail pages. See `demo/basic.md`.
- Use horizontal Anchor for compact top navigation between sections. See `demo/horizontal.md`.
- Use `targetOffset`, `onClick`, or `onChange` when scroll position or active section needs custom behavior. See `demo/targetOffset.md`, `demo/onClick.md`, and `demo/onChange.md`.
- Prefer Breadcrumb for hierarchy navigation and Tabs for switching peer views.
