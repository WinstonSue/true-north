...
import type { TreeDataNode, TreeEmits } from '@sue/design-web-vue'
import { ClipboardCheck, Check, NotebookPen } from '@lucide/vue'
    ...
    children: [
      {
        ...
        icon: h(ClipboardCheck),
        children: [
          { title: 'leaf', key: '0-0-0-0', icon: h(ClipboardCheck) },
          {
            key: '0-0-0-1',
            icon: h(ClipboardCheck),
          },
          { title: 'leaf', key: '0-0-0-2', icon: h(ClipboardCheck) },
        ],
      },
      {
        title: 'parent 1-1',
        key: '0-0-1',
        icon: h(ClipboardCheck),
        children: [{ title: 'leaf', key: '0-0-1-0', icon: h(ClipboardCheck) }],
      },
      {
        title: 'parent 1-2',
        key: '0-0-2',
        icon: h(ClipboardCheck),
        children: [
          { title: 'leaf', key: '0-0-2-0', icon: h(ClipboardCheck) },
          {
            title: 'leaf',
            key: '0-0-2-1',
            icon: h(ClipboardCheck),
            switcherIcon: h(NotebookPen),
          },
        ],
      },
    ],
    ...
    children: [
      {
        ...
        icon: h(ClipboardCheck),
        children: [
          { title: 'leaf', key: '0-1-0-0', icon: h(ClipboardCheck) },
          { title: 'leaf', key: '0-1-0-1', icon: h(ClipboardCheck) },
        ],
      },
    ],
  },
...
<template>
  <div>
    <div class="mb-16px">
      showLine: <sue-switch v-model:checked="showLine" />
      <br>
      <br>
      showIcon: <sue-switch v-model:checked="showIcon" />
      <br>
      <br>
      showLeafIcon:
      <sue-select
