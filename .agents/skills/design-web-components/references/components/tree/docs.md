...
- Use Tree to display hierarchical data that users browse, select, search, drag, or load lazily. See `demo/basic.md`.
- Use controlled, searchable, dynamic loading, draggable, line, or directory demos for common tree behavior. See `demo/basic-controlled.md`, `demo/search.md`, `demo/dynamic.md`, `demo/draggable.md`, `demo/line.md`, and `demo/directory.md`.
- Use virtual scroll, big data, block node, custom icon, or multiple-line demos for large or rich trees. See `demo/virtual-scroll.md`, `demo/big-data.md`, `demo/block-node.md`, `demo/customized-icon.md`, and `demo/multiple-line.md`.
- Prefer TreeSelect when the hierarchy is part of a form field.
