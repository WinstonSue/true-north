...
- Use Avatar to represent a user, team, organization, or entity with an image, icon, or initials. See `demo/basic.md` and `demo/type.md`.
- Use Avatar.Group for multiple related people or participants. See `demo/group.md`.
- Use Badge with Avatar for presence, notification, or count indicators. See `demo/badge.md`.
- Use responsive sizing when avatar size must adapt to container or viewport. See `demo/responsive.md`.
...
| size | The size of the avatar | AvatarSize | `medium` | - |
| shape | The shape of avatar | 'circle' \| 'square' | `circle` | - |
