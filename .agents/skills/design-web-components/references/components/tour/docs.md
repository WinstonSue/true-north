...
- Use Tour for guided onboarding or feature discovery flows. See `demo/basic.md`.
- Use placement, mask, gap, non-modal, indicator, or actions render demos for tour behavior. See `demo/placement.md`, `demo/mask.md`, `demo/gap.md`, `demo/non-modal.md`, `demo/indicator.md`, and `demo/actions-render.md`.
- Prefer Tooltip or Popover for isolated hints that are not part of a sequence.
