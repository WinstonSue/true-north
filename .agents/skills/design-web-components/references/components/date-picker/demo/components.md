...
const MyDatePanel = defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      const Flex = resolveComponent('sue-flex') as any
      const Slider = resolveComponent('sue-slider') as any
      const Title = resolveComponent('sue-editable-text') as any
      const Button = resolveComponent('sue-button') as any
