...
export const CONTROLLER_SOURCE_PATH = path.join(ROOT, 'apps/desktop/service/growth');
export const CONTROLLER_PROXY_TARGET_PATH = path.join(ROOT, 'apps/desktop/service/growth');
...
export const DTO_SOURCE_PATH = path.join(ROOT, 'apps/desktop/service/growth');
