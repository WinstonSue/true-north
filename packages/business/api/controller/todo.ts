...
export default class TodoController {
  ...
  static async updateWithRepeat(id: string, body: any) {
    return request<TodoVO.TodoVo>({ method: "put" })(`/todo/update-with-repeat/${id}`, body);
  }

  static async doneWithRepeatBatch(params: any) {
    return request<any>({ method: "put" })(`/todo/done-with-repeat/batch`, params);
  }
  ...
  static async listMixRepeat(params: any) {
