...
export type Habit = { id: string; title: string; goalIds: string[]; status: HabitStatus; importance: number; difficulty: number; weights: Record<string, number>; frequency: HabitFrequency; reminder: Reminder; tags: string[]; streak: number; longest: number; logs: Array<{ date: string; score: Score; mood: string; note: string }> };
