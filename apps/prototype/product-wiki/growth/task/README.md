...
| 字段：任务.状态 | v0.1.1 | 2026-07-30 | changed | 路线图 | 完整覆盖 | 移除受阻状态。 |
| 字段：任务.预计耗时 | v0.1.0 | 2026-07-28 | baseline | 路线图 | 完整覆盖 | 建立字段基线。 |
| 视图：今日任务 | v0.1.0 | 2026-07-29 | baseline | 路线图 | 部分覆盖 | 建立今日任务视图。 |
| 视图：本周任务 | v0.1.0 | 2026-07-28 | baseline | 路线图 | 部分覆盖 | 建立视图基线。 |
| 视图：全部任务 | v0.1.0 | 2026-07-28 | baseline | 路线图 | 部分覆盖 | 建立视图基线。 |
| 视图：任务统计 | v0.1.0 | 2026-07-29 | baseline | 路线图 | 部分覆盖 | 建立任务执行概览。 |
