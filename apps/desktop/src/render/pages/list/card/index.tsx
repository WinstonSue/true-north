...
import { Tabs, Card, Input, Row, Col } from '@sue/design-web-react';
...
export default function ListCard() {
  ...
  return (
    <Card>
      <h6 className="text-title-1 font-medium">{t['menu.list.card']}</h6>
      <Tabs
        activeKey={activeKey}
      ...
      <div className={styles.container}>
        ...
        <div key={key}>
              <h6 className="text-title-1 font-medium">{t[`cardList.tab.title.${key}`]}</h6>
