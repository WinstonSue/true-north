...
key_metrics:
  user_metrics:
    - name: "日活跃用户(DAU)"
      definition: "每日登录并使用核心功能的用户数"
      
    - name: "用户留存率"
      definition: "新用户在第7天、第30天的留存比例"
      
  business_metrics:
    - name: "目标完成率"
      definition: "用户设定目标的实际完成比例"
      
    - name: "功能使用率"
      definition: "各核心功能的用户使用比例"
      
  technical_metrics:
    - name: "系统可用性"
      definition: "系统正常运行时间比例，目标99.9%"
      
    - name: "响应时间"
      definition: "API平均响应时间，目标<500ms"
```
...
content_standards:
  user_generated_content:
    moderation: "自动过滤 + 人工审核"
    guidelines: "禁止违法、暴力、色情内容"
...
kpi_system:
  ...
  business_health:
    - goal_completion_rate: "目标完成率"
    - habit_consistency: "习惯坚持度"
    - task_efficiency: "任务完成效率"
```

### 数据分析体系
- **用户行为分析**: 功能使用路径、停留时间、操作频次
- **业务效果分析**: 目标达成情况、习惯养成效果
- **系统性能分析**: 响应时间、错误率、可用性
